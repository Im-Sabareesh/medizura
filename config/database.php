...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'hms' => [
            'driver' => 'mysql',
            'host' => env('DB_HMS_HOST', '127.0.0.1'),
            'port' => env('DB_HMS_PORT', 3306),
            'database' => env('DB_HMS_DATABASE', 'forge'),
            'username' => env('DB_HMS_USERNAME', 'forge'),
            ...
            'strict' => env('DB_HMS_STRICT_MODE', false),
